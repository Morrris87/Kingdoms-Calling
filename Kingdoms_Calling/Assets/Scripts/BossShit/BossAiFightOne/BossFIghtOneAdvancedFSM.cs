...
namespace CompleteBossOne
{
    ...
    {
        private List<BossFightOneFSMState> fsmStates;

        private FSMStateID currentStateID;
        public FSMStateID CurrentStateID { get { return currentStateID; } }

        private BossFightOneFSMState currentState;
        public BossFightOneFSMState CurrentState { get { return currentState; } }

        [HideInInspector]
        public GameObject Player;

        public BossFIghtOneAdvancedFSM()
        {
            fsmStates = new List<BossFightOneFSMState>();
        }
        public void AddFSMState(BossFightOneFSMState fsmState)
        {
            ...
            foreach (BossFightOneFSMState state in fsmStates)
            {
